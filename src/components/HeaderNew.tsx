      ...
      <div className="container overflow-visible">
        <div className="flex items-center justify-between h-16 md:h-20 overflow-visible">
          ...
          <a href="/" className="flex items-center gap-3 relative">
            <img src={logo} alt="Mason Outdoor Service LLC" className="w-44 h-44 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-xl object-cover shadow-lg ring-2 ring-background/50 relative z-[60] translate-y-8" />
