...
const testimonials = [
  {
    ...
    text: "Mason Outdoor Service LLC has been plowing our driveway for 3 winters now. Always on time, even during the worst storms. Couldn't ask for better service!",
    rating: 5,
  },
  {
    name: "Tom & Linda K.",
